...
def overview_sig(data_obs, data_sig):
    ...
    # Graph of the C isotopic signatures
    data_obs.plot(y=col_d13C, markersize=1, style='o', legend=False, ax=ax2, mec=cP, mfc=cP)
    data_sig.plot(x=col_dt_d13C, y=col_d13C, markersize=1, style='o', legend=False, ax=ax2, mec='g', mfc='g')
    ax2.set_ylabel(d13C+' [\u2030]')
    #ax2.legend(fontsize=15)
    ...
    data_obs.plot(y=col_dD, markersize=1, style='o', legend=False, ax=ax3,  mec=cP, mfc=cP)
    data_sig.plot(x=col_dt_dD, y=col_dD, markersize=1, style='o', legend=False, ax=ax3,  mec='b', mfc='b')
    ax3.set_ylabel(dD+' [\u2030]')
    #ax3.legend(fontsize=15)
...
def overview_pk(data_obs, data_pk):
