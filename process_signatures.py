...
ax_pk_d13C.text(x=np.mean(df_PKE[col_d13C])+0.1, y=0.8, s='%.1f' % np.mean(df_PKE[col_d13C])+' ± %.1f' % np.std(df_PKE[col_d13C]), color='gray', transform=trans_d13C, fontsize=22, rotation='vertical')
...
# PKE derived peaks
f1, ax1 = fg.overview_pk(df_IRMS, [df_PKE], [df_PKE_edgar5, df_PKE_tno5], names=['obs -original', 'EDGAR -calc5bis', 'TNO -calc5bis'])
f1.savefig(f_path+today+'/overview_PKEpeaks_original&calc5bis_prom=100ppb_minH=10perc_n=3.png', dpi=300)
...
f4.savefig(f_path+today+'/top-diagram_PKE-bg_original&calc5bis.png', dpi=300)
...
dfPKE_dD_all, dfPKE_dD_edgar5i = fun.two_isotopes(df_PKE[[col_dt_dD, 'start_'+col_dt_dD, 'end_'+col_dt_dD, col_dD, col_errdD, col_wd+'_dD', col_errwd+'_dD', col_ws+'_dD', col_errws+'_dD']].dropna(), 
                                                  df_pkdD_edgar5[[col_dt_dD, 'start_'+col_dt_dD, 'end_'+col_dt_dD, col_dD, col_errdD, col_wd+'_dD', col_errwd+'_dD', col_ws+'_dD', col_errws+'_dD']].dropna(), h, iso='D')
dfPKE_d13C_all, dfPKE_d13C_edgar5i = fun.two_isotopes(df_PKE[[col_dt_d13C, 'start_'+col_dt_d13C, 'end_'+col_dt_d13C, col_d13C, col_errd13C, col_wd+'_d13C', col_errwd+'_d13C', col_ws+'_d13C', col_errws+'_d13C']].dropna(), 
                                                      df_pkd13C_edgar5[[col_dt_d13C, 'start_'+col_dt_d13C, 'end_'+col_dt_d13C, col_d13C, col_errd13C, col_wd+'_d13C', col_errwd+'_d13C', col_ws+'_d13C', col_errws+'_d13C']].dropna(), h, iso='13C')
dfPKE_dD_all, dfPKE_dD_tno5i = fun.two_isotopes(df_PKE[[col_dt_dD, 'start_'+col_dt_dD, 'end_'+col_dt_dD, col_dD, col_errdD, col_wd+'_dD', col_errwd+'_dD', col_ws+'_dD', col_errws+'_dD']].dropna(), 
                                                df_pkdD_tno5[[col_dt_dD, 'start_'+col_dt_dD, 'end_'+col_dt_dD, col_dD, col_errdD, col_wd+'_dD', col_errwd+'_dD', col_ws+'_dD', col_errws+'_dD']].dropna(), h, iso='D')
dfPKE_d13C_all, dfPKE_d13C_tno5i = fun.two_isotopes(df_PKE[[col_dt_d13C, 'start_'+col_dt_d13C, 'end_'+col_dt_d13C, col_d13C, col_errd13C, col_wd+'_d13C', col_errwd+'_d13C', col_ws+'_d13C', col_errws+'_d13C']].dropna(), 
                                                    df_pkd13C_tno5[[col_dt_d13C, 'start_'+col_dt_d13C, 'end_'+col_dt_d13C, col_d13C, col_errd13C, col_wd+'_d13C', col_errwd+'_d13C', col_ws+'_d13C', col_errws+'_d13C']].dropna(), h, iso='13C')
...
f_corr_pkd13C[0].savefig(f_path+today+'/corr_PKE-d13C_IRMS&calc5bis.png', dpi=300, transparent=True)
...
f_corr_pkdD[0].savefig(f_path+today+'/corr_PKE-dD_IRMS&calc5bis.png', dpi=300, transparent=True)
